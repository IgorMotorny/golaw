...
(function () {
    ...
    lang.getHeight = function () {
        ...
        var itemHeight = this.items.outerHeight(true) + this.obj.innerHeight() - this.obj.outerHeight();
    ...
    $(selector.item + ', ' + selector.navItem).on('click tocuh', function () {
        var $item = $(this);
        var index = $item.attr('data-lang');

        $(selector.item + '.' + selector.active).removeClass(selector.active);

        $(selector.navItem + '.' + selector.active).removeClass(selector.active);
...
(function () {
    ...
    var navigation = new Menu('.navigation__list', partitions);
})();
'use strict';

(function () {
    var tabs = {
        search: '.people-menu__search',
        practices: '.people-menu__practices',
        sectors: '.people-menu__sectors'
    };

    var navigation = new Menu('.people-menu__tabs', tabs);
})();
'use strict';

(function () {
    var searchField = $('.search');
    var searchInput = searchField.find('input[type="search"]');
    var logo = $('.header__left');
...
(function () {
    ...
    var services = new Menu('.services-main__menu', partitions, 768);
...
var selectors = {
    slider: {
        obj: '.slider-main',
        list: '.slider-main__list',
        item: '.slider-main__item',
        video: '.slider-main__video',
        next: '.arrow-right',
        prev: '.arrow-left',
        nextImg: '.slider-main__next'
    },
    cases: {
        item: '.cases__item',
        al: '.cases__all'
    ...
    timeline: {
        progress: '.timeline__progress',
        more: '.timeline__more',
        counter: '.timeline__counter'
    },
    hide: 'hide',
    hidden: 'hidden',
    active: 'active'
